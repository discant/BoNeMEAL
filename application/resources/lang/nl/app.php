...
return [
	...
	"choice" => [
		...
		"activeBan"		=> "actieve ban|actieve bans",
	...
	"sendPasswordResetLink"		=> "Verzen Wachtwoord Herstellink",
	...
	"edit"						=> "Bewerk",
	"playerNotExist"			=> "A speler with that name does not exist.",
	"activity"					=> "Activiteit",
	"onlinePlayers"				=> "Online spelers",
	"playerSplit"				=> "speler split",
	...
	"ok"						=> "Okay",
	"bannedPlayer"				=> "Successfully banned speler.",
	"mutedPlayer"				=> "Successfully muted speler.",
	"warnedPlayer"				=> "Successfully warned speler.",
	"notedPlayer"				=> "Successfully attached note to speler.",
