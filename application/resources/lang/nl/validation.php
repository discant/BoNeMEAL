...
return [
	...
	*/
	...
	"size"                 => [
		...
		"array"   => "Het :attribute moet :size objecten bevatten.",
	],
	"unique"               => "De :attribute is al bezet.",
	"url"                  => "Het :attribute formaat is ongeldig.",
	"timezone"             => "De :attribute moet een geldige zone zijn.",
	"role"                 => "De :attribute moet een geldige gebruikersrol zijn.",
	"future"               => "De :attribute moet een geldige verloopsdatum en -tijd zijn.",
